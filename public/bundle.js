...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeTitle = _react2['default'].createClass({
	...
	var RecipeIndIng = _react2['default'].createClass({
		displayName: 'RecipeIndIng',
	...
	var RecipeIngredients = _react2['default'].createClass({
		...
		render: function render() {
			...
			this.props.ingredients.forEach(function (ing) {
				indIng.push(_react2['default'].createElement(RecipeIndIng, { indIng: ing, key: ing }));
			});
			...
			this.state.recipes.forEach(function (recipe) {
				recipesArray.push(_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'well' },
						_react2['default'].createElement(RecipeTitle, { title: recipe.title, key: recipe.id }),
						_react2['default'].createElement(RecipeIngredients, { ingredients: recipe.ingredients, key: recipe.title })
					)
				));
			});
			return _react2['default'].createElement(
	...
	var TextForm = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement(
				'form',
				{ action: '/textme', method: 'post' },
				_react2['default'].createElement('textarea', { className: 'form-control grocery-list', rows: '10' }),
				_react2['default'].createElement(
					'button',
	...
	var TwilioForm = _react2['default'].createClass({
		displayName: 'TwilioForm',
	
		render: function render() {
			return _react2['default'].createElement(
				'div',
				{ id: 'twilioForm', className: 'row' },
				_react2['default'].createElement(
					'div',
					{ className: 'col-md-6 col-md-offset-3' },
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(TextForm, null)
						)
					)
				)
			);
	...
	var Profile = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement(
				'span',
				null,
				_react2['default'].createElement(TwilioForm, null),
				_react2['default'].createElement(RecipeList, { recipeList: initialState })
			);
		}
	});
	
	window.addEventListener('load', function (e) {
		if (window.location.pathname === '/profile') _reactDom2['default'].render(_react2['default'].createElement(Profile, null), document.getElementById('container'));
	});
